...
use crate::scene::add_shapes_to_scene;
            ...
            WindowEvent::RedrawRequested => {
                ...
                if let Some(cid) = canvas_id {
                    ...
                    if need_restore {
                        ...
                        self.context.resize_surface(surface, export_w, export_h);
                        ...
                        let surface_texture = surface.surface.get_current_texture().expect("get current texture");
...
pub async fn run_all_canvases_async() {
    ...
    let mut app = VelloRendererApp { context, renderers, states, scene: Scene::new() };
