...
describe('Image Exporter', () => {
  it('should export empty canvas correctly.', async () => {
    ...
    expect(dataURL).toBe(
      'data:image/svg+xml;charset=utf8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%22200%22%20height%3D%22200%22%3E%3Cg%3E%3Cg%2F%3E%3C%2Fg%3E%3C%2Fsvg%3E',
    );
