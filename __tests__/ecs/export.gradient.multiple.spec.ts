...
describe('Export SVG', () => {
  it('should export multiple gradients correctly', (done) => {
    const app = new App();
    ...
    class StartUpSystem extends System {
        ...
        api.updateNodes([
          {
            id: '1',
            type: 'rect',
            fills: [{ type: 'gradient', value: 'linear-gradient(to right, red, blue), radial-gradient(circle at center, red, blue)', opacity: 1 }],
            x: 50,
            y: 50,
            width: 100,
            height: 100,
      ...
      execute(): void {
        this.screenshots.added.forEach(async (screenshot) => {
          ...
          expectToMatchSVGSnapshotWithDone(svg, dir, 'export-gradient-multiple', done);
