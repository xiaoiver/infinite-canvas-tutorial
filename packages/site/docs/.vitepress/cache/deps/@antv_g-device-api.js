...
function getUniforms(vert) {
  ...
  vert.replace(/\s*struct\s*(.*)\s*{((?:\s*.*\s*)*?)};/g, function(_, type, uniformStr) {
    ...
    uniformStr.trim().replace("\r\n", "\n").split("\n").forEach(function(line) {
      var _a2 = __read(line.trim().split(/\s+/), 2), type2 = _a2[0], name = _a2[1];
      uniforms.push({
        type: type2.trim(),
          ...
          if (isArray) {
            var _loop_1 = function(i2) {
              struct.uniforms.forEach(function(uniform) {
                uniformNames.push("".concat(name, "[").concat(i2, "].").concat(uniform.name));
              });
            };
            for (var i = 0; i < 5; i++) {
              _loop_1(i);
...
var Buffer_GL = (
  ...
  function(_super) {
    ...
    function Buffer_GL2(_a2) {
      ...
      var byteSize = is_number_default(viewOrSize) ? align(viewOrSize, 4) : align(viewOrSize.byteLength, 4);
          ...
          try {
            for (var attributes_1 = (e_2 = void 0, __values(attributes)), attributes_1_1 = attributes_1.next(); !attributes_1_1.done; attributes_1_1 = attributes_1.next()) {
              ...
              if (!is_nil_default(location_1)) {
                ...
                gl.vertexAttribPointer(location_1, size2, type, normalized, 0, 0);
        ...
        if (descriptor.dimension === TextureDimension.TEXTURE_2D) {
          ...
          if (_this.immutable) {
            if (isWebGL2(gl)) {
              ...
              if ((_this.format === Format.D32F || _this.format === Format.D24_S8) && !isWebGL2(gl) && !device.WEBGL_depth_texture)
                ;
              else {
  ...
  function(_super) {
    ...
    Program_GL2.prototype.readAttributesFromLinkedProgram = function() {
      ...
      var _loop_1 = function(index2) {
        var _b = gl.getActiveAttrib(this_1.gl_program, index2), name_1 = _b.name, type = _b.type, size2 = _b.size;
      ...
      return new Promise(function(resolve, reject) {
        function test() {
          ...
          if (res == gl.TIMEOUT_EXPIRED) {
            setTimeout(test, clamp_default(interval_ms, 0, gl.MAX_CLIENT_WAIT_TIMEOUT_WEBGL));
            return;
          }
          resolve();
        }
...
var Device_GL = (
  ...
  function() {
    ...
    Device_GL2.prototype.createRenderTargetFromTexture = function(texture) {
      var _a2 = texture, format = _a2.format, width = _a2.width, height = _a2.height, mipLevelCount = _a2.mipLevelCount;
    ...
    Device_GL2.prototype.queryTextureFormatSupported = function(format, width, height) {
      switch (format) {
        case Format.BC1_SRGB:
        case Format.BC2_SRGB:
        case Format.BC3_SRGB:
    ...
    Device_GL2.prototype.bindFramebufferDepthStencilAttachment = function(framebuffer, attachment) {
      var gl = this.gl;
      var flags = !is_nil_default(attachment) ? getFormatFlags(attachment.format) : FormatFlags.Depth | FormatFlags.Stencil;
    ...
    Device_GL2.prototype.setRenderPassParametersBegin = function(numColorAttachments) {
      var gl = this.gl;
      if (isWebGL2(gl)) {
    ...
    Device_GL2.prototype.setRenderPassParametersColor = function(i, colorAttachment, attachmentLevel, colorResolveTo, resolveToLevel) {
      var gl = this.gl;
      var gl2 = isWebGL2(gl);
    ...
    Device_GL2.prototype.setRenderPassParametersDepthStencil = function(depthStencilAttachment, depthStencilResolveTo) {
      var gl = this.gl;
      ...
      for (var i = 0; i < bindingLayoutTable.numSamplers; i++) {
        ...
        if (this.currentTextures[samplerIndex] !== gl_texture) {
          ...
          if (gl_texture !== null) {
            ...
            gl.bindTexture(gl_target, this.getFallbackTexture(__assign({ gl_target, formatKind }, samplerEntry)));
          }
...
var WebGLDeviceContribution = (
  ...
  function() {
    ...
    WebGLDeviceContribution2.prototype.createSwapChain = function($canvas) {
      return __awaiter(this, void 0, void 0, function() {
        var _a2, targets, xrCompatible, _b, antialias, _c, preserveDrawingBuffer, _d, premultipliedAlpha, shaderDebug, trackResources, options, gl;
...
var Buffer_WebGPU = (
  ...
  function(_super) {
    ...
    function Buffer_WebGPU2(_a2) {
      ...
      _this.size = is_number_default(viewOrSize) ? align(viewOrSize, 4) : align(viewOrSize.byteLength, 4);
      if (!is_number_default(viewOrSize)) {
...
var RenderPass_WebGPU = (
  ...
  function() {
    ...
    RenderPass_WebGPU2.prototype.setRenderPassDescriptor = function(descriptor) {
      ...
      this.gpuRenderPassDescriptor.occlusionQuerySet = !is_nil_default(descriptor.occlusionQueryPool) ? getPlatformQuerySet(descriptor.occlusionQueryPool) : void 0;
    };
...
var Device_WebGPU = (
  ...
  function() {
    ...
    Device_WebGPU2.prototype.createRenderTargetFromTexture = function(texture) {
      var _a2 = texture, format = _a2.format, width = _a2.width, height = _a2.height, depthOrArrayLayers = _a2.depthOrArrayLayers, sampleCount = _a2.sampleCount, mipLevelCount = _a2.mipLevelCount, gpuTexture = _a2.gpuTexture, gpuTextureView = _a2.gpuTextureView, usage = _a2.usage;
    ...
    Device_WebGPU2.prototype.queryTextureFormatSupported = function(format, width, height) {
