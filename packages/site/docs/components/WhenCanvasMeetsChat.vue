  ...
  onReady = async (e) => {
    ...
    const nodes = [
      ...
      } as const,
      {
        ...
        name: 'A swimming cat',
        type: 'rect',
        fills: [{ type: 'image', value: 'https://v3b.fal.media/files/b/koala/0RQAsrw5rRX015XQUd4HX.jpg', opacity: 1 }],
        x: 200 + 1200,
        y: 150,
        width: 1024,
        height: 1024,
      ...
      } as const,
      {
        ...
        type: 'rect',
        fills: [{ type: 'image', value: 'https://v3b.fal.media/files/b/panda/Xo61xntJdsl8_txn9WC-5.jpg', opacity: 1 }],
        x: 200 + 2400,
        y: 150,
        width: 1024,
        height: 1024,
      ...
      } as const,
      {
        ...
        fills: [{ type: 'image', value: 'https://v3.fal.media/files/penguin/9UH5Fgin7zc1u6NGGItGB.jpeg', opacity: 1 }],
        x: 1400,
        y: 1400,
        width: 1408,
        height: 736,
