...
export const PROVIDERS: ProviderInfo[] = [
    ...
    },
    {
        ...
        models: [
            ...
            { value: 'openai/gpt-5.1-codex', label: 'GPT-5.1 Codex', provider: 'openai', capabilities: ['text', 'chat'] },
    ...
    },
    {
        ...
        models: [
            ...
            { value: 'anthropic/claude-3-7-sonnet-latest', label: 'Claude 3.7 Sonnet', provider: 'anthropic', capabilities: ['text', 'chat'] },
            { value: 'anthropic/claude-3-5-sonnet-latest', label: 'Claude 3.5 Sonnet', provider: 'anthropic', capabilities: ['text', 'chat'] },
            { value: 'anthropic/claude-3-5-haiku-latest', label: 'Claude 3.5 Haiku', provider: 'anthropic', capabilities: ['text', 'chat'] },
            { value: 'anthropic/claude-3-opus-latest', label: 'Claude 3 Opus', provider: 'anthropic', capabilities: ['text', 'chat'] },
        ],
    },
    {
        value: 'google',
        ...
        models: [
            ...
            { value: 'google/gemini-1.5-pro', label: 'Gemini 1.5 Pro', provider: 'google', capabilities: ['text', 'chat'] },
            { value: 'google/gemini-1.5-flash', label: 'Gemini 1.5 Flash', provider: 'google', capabilities: ['text', 'chat'] },
        ],
    },
    // {
    //     value: 'groq',
