...
@customElement('ic-canvas-lesson10')
export class InfiniteCanvas extends LitElement {
  ...
  render() {
    return html`
      <sl-resize-observer>
        <canvas></canvas>
        <ic-zoom-toolbar-lesson10 zoom=${this.zoom}></ic-zoom-toolbar-lesson10>
        <ic-exporter-lesson10></ic-exporter-lesson10>
      </sl-resize-observer>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'ic-canvas-lesson10': InfiniteCanvas;
  }
}
